...
## Overview
A professional web application for efficient task and subtask management, featuring a robust admin panel. Built with HTML, CSS, JavaScript (AJAX/JSON), and PHP (MySQL), this app supports individual and team productivity with modern UI/UX and secure.
